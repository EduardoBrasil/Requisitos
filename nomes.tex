...
\newcommand{\eduardo}{{Eduardo Brasil Martins}}					%Sem link
\newcommand{\bruno}{{Bruno Contessotto Bragança}}
\newcommand{\rafaelmatricula}{11/0136942}
\newcommand{\thiagomatricula}{12/00****}
\newcommand{\eduardomatricula}{11/0115104}
\newcommand{\brunomatricula}{11/09*****}
\newcommand{\erafael}{rafael_fazzolino@hotmail.com}
...
{
	\newcommand{\names}{\rafael~-~\rafaelmatricula\\\thiago~-~\thiagomatricula\\\eduardo~-~\eduardomatricula\\\bruno~-~\brunomatricula}
