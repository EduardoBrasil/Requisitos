...
O detalhamento dos casos de uso está presente na Seção \ref{sec:documento_de_caso_de_uso} deste documento, assim como os \textit{roadmaps} se encontram na Seção \ref{sec:road_map}.
