...
\subsection{Requisitos Funcionais}
	...
	\begin{itemize}
		\item Característica C1.1.1 - Manter metodologias tradicionais
			\begin{itemize}
				\item RF001 - Cadastrar problema na ferramenta;
				\item RF002- Ler problema na ferramenta;
				\item RF003 - Atualizar problema na ferramenta;
				\item RF004 - Remover problema na ferramenta;
			\end{itemize}
	\end{itemize}
%-----------------------------------------------------------------------------------------------------------
