...
\subsection{Requisitos Funcionais}
	...
	\begin{itemize}
		\item RF01 - O sistema deverá manter os requisitos independente da abordagem selecionada;
		\item RF02 - O sistema deverá indicar a abordagem ideal para o projeto;
		\item RF03 - O sistema deverá permitir ao usuário adaptar a abordagem;
		\item RF04 - O sistema deverá realizar cadastro para que o usuário possa acessar seus projetos;
		\item RF05 - O sistema deverá diferenciar usuários pelo nível de acesso nos projetos;
		\item RF06 - O sistema deverá controlar quais usuários estão em cada projeto;
		...
		\item RF09 - O sistema deverá manter o controle das mudanças;
		\item RF10 - O sistema deverá gerar abordagens novas caso necessário.
	\end{itemize}
%-----------------------------------------------------------------------------------------------------------
