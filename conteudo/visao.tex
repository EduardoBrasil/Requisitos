...
\paragraph{Necessidade 1.1 - Utilização de ferramentas que se adequem as metodologias}
	...
	\subparagraph{Característica 1.1.1 - Manter metodologias tradicionais}
		\begin{itemize}
			\item Caso de uso 1.1.1.1 - Manter Problema;
			\item Caso de uso 1.1.1.2 - Manter Necessidades;
			\item Caso de uso 1.1.1.3 - Manter Características;
			\item Caso de uso 1.1.1.4 - Manter Casos de Uso.
		\end{itemize}
	
	\subparagraph{Característica 1.1.2 - Manter metodologias ágeis}
		\begin{itemize}
			\item Caso de uso 1.1.2.1 - Manter Temas de Investimento;
			\item Caso de uso 1.1.2.2 - Manter Épicos;
			\item Caso de uso 1.1.2.3 - Manter Features;
			\item Caso de uso 1.1.2.4 - Manter Histórias de Usuário.
		\end{itemize}

\paragraph{Necessidade 1.2 - Apoio a utilização de uma rastreabilidade organizada e eficiente em qualquer abordagem}
	\subparagraph{Característica 1.2.1 - Manter informações sobre requisitos}
		\begin{itemize}
			\item Caso de uso 1.2.1.1 - Manter Atributos;
			\item Caso de uso 1.2.1.2 - Manter \textit{Roadmaps}.
		\end{itemize}

	\subparagraph{Característica 1.2.2 - Manter relação entre Requisitos}
		\begin{itemize}
			\item Caso de uso 1.2.2.1 - Manter rastreabilidade horizontal entre os requisitos;
			\item Caso de uso 1.2.2.2 - Manter rastreabilidade vertical entre os requisitos.
		\end{itemize}

\paragraph{Necessidade 1.3 - Obter critérios fixos que direcionem o projeto para abordagem mais adequada}
	\subparagraph{Característica 1.3.1 - Auxiliar na escolha da metodologia}
		\begin{itemize}
			\item Caso de Uso 1.3.1.1 - Definir Metodologia.
		\end{itemize}

\paragraph{Necessidade 1.4 - Obter um processo de \er~ adaptável a qualquer abordagem}
	\subparagraph{Característica 1.4.1 - Criar processos Híbridos}
	\begin{itemize}
		\item Caso de uso 1.4.1.1 - Definir ``hibridez'' do projeto;
		\item Caso de uso 1.4.1.2 - Manter processos híbridos.
	\end{itemize}

\paragraph{Necessidade 1.5 - Gerar documentação de qualidade e fácil entendimento}
	\subparagraph{Característica 1.5.1 - Gerar e manter diagramas}
		\begin{itemize}
			\item Caso de uso 1.5.1.1 - Gerar \textit{Diagrama de Ishikawa};
			\item Caso de uso 1.5.1.2 - Gerar Diagramas de Casos de Uso.
		\end{itemize}

	\subparagraph{Característica 1.5.2 - Controlar projeto por toda sua duração}
		\begin{enumerate}
			\item Caso de uso 1.5.2.1 - Gerar plano de iteração;
			\item Caso de uso 1.5.2.2 - Controlar histórico de versão.
		\end{enumerate}
